...
export function fetchAlbum(
  ...
  noCache: boolean
): AxiosPromise<FetchAlbumResponse> {
...
): AxiosPromise<LikeAAlbumResponse> {
  return request({
    url: '/album/sub',
    method: 'post',
    params: {
 ...
 */
 export function newAlbums(params: NewALbumsParams = defaultNewAlbumsParams): AxiosPromise<ResponseType> {
  return request({
    url: '/album/new',
    method: 'get',
    params,
