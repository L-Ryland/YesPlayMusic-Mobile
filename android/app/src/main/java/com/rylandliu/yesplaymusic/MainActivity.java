...
//        setContentView(R.layout.activity_main);
    ...
    Log.d("onCreate", "onCreate: isStartedNodeAlready?"+ _startedNodeAlready);
    if (!_startedNodeAlready) {
      ...
      new Thread(new Runnable() {
        ...
        public void run() {
          ...
          Log.d("nodejs", "nodeDir: " + nodeDir);
          if (wasAPKUpdated()) {
            Log.d("nodejs", "was apk updated");
            //Recursively delete any existing nodejs-project.
            File nodeDirReference = new File(nodeDir);
            if (nodeDirReference.exists()) {
              deleteFolderRecursively(new File(nodeDir));
              Log.d("nodejs", "delete done");
            }
          ...
          Log.d("nodeJs", "nodeJs will update...");
        }
      }).start();
      Log.d("nodejs", "start done");
    }
  }
